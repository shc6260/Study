...
namespace _1005Program.ProcessView
{
    public partial class Form1 : Form
    {
            ...
            try
            {
                this.lvView.Items.Clear(); cp = 0; foreach (var proc in Process.GetProcesses())
                {
                    ...
                    var strArray = new string[] {
                        proc.ProcessName.ToString(), proc.Id.ToString(), str[0], NumFormat(proc.WorkingSet64)
                    };
        ...
        { while (!bExit) { int iCPU = (int)oCPU.NextValue(); int iMem = (int)oMem.NextValue(); Invoke(OnTotal, iCPU, iMem); Thread.Sleep(1000); } }
